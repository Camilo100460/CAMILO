...
let handler = async (m, { conn, command, text }) => {
    ...
    // Verificar si el usuario ha usado el comando en los últimos 30 segundos
    if (lastUsed[m.sender] && currentTime - lastUsed[m.sender] < 30000) {
        m.reply("_⌛ Tiempo de uso del comando agotado. Por favor, vuelve a intentarlo más tarde._");
        return;
    }

    // Actualizar el tiempo del último uso para este usuario
    lastUsed[m.sender] = currentTime;
